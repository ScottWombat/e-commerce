...
async def count_items(client: AsyncIOMotorClient) -> ItemResponse: # type: ignore
...
async def delete_item_by_id(client: AsyncIOMotorClient,id: str) -> ItemResponse: # type: ignore
    try:
...
async def delete_all_items(client: AsyncIOMotorClient)-> ItemResponse: # type: ignore
    try:
...
async def create_item(item: Item, client: AsyncIOMotorClient) -> ItemResponse: # type: ignore
    try:
